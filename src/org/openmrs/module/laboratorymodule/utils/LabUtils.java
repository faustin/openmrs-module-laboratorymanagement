...
public class LabUtils {
	...
	public static Obs createObs(Obs existingObs, Order labOrder, Concept cpt,
		...
		if (existingObs == null) {
			log.info(">>>>is this Lab order concepts>" + labOrder.getConcept()
					+ " has  value" + obsValue);
			existingObs = new Obs();
	...
	public static void addLabresults(Map<String, String[]> parameterMap) {
		...
		for (String parameterName : parameterMap.keySet()) {
			...
			if (isMultipleAnswer) {
				...
				saveSingleResult(labOrder, singleValue, memberConcept);
			}
		}
	}
	...
	public static void saveMultipleResultsOnOnelabtest(Order labOrder,
			String[] parameterValues, Concept memberConcept) {
	...
	public static Patient getPatientByLabCode(String labCode) {
		...
		log.info("***************PATIENT****************** \n"
		+ Context.getPatientService().getPatient(patientId).getGivenName());
